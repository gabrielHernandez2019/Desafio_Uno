# Solución Gabriel Hernández:

-   Para la solución Use el nivel 3 con Java 8 y Spring Boot.
-   Desafio_Uno lo configure en el puerto 8081.
...
*   java -jar target/consulta-datos-0.0.1-SNAPSHOT.war.

#  Consumir la API

El servicio es de tipo Get:

* http://localhost:8080/v1/datos/consulta/periodos
